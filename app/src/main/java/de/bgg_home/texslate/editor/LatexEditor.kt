...
private const val THEME_LIGHT = "texslate-light"
private const val THEME_DARK = "texslate-dark"
...
private object TextMateAssets {
    ...
    fun ensureLoaded(context: Context) {
        ...
        loadTheme(themeRegistry, "textmate/themes/texslate-light.json", THEME_LIGHT, dark = false)
        loadTheme(themeRegistry, "textmate/themes/texslate-dark.json", THEME_DARK, dark = true)
